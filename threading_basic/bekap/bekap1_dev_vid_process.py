...
def main():
    ...
    synthethic_out1 = cv2.VideoWriter("out_"+input_filename1, cv2.VideoWriter_fourcc(*'mp4v'), 25, (width, height))
    ...
    synthethic_out2 = cv2.VideoWriter("out_"+input_filename2, cv2.VideoWriter_fourcc(*'mp4v'), 25, (width,height))
