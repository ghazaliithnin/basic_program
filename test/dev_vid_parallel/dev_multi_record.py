# -*- coding: utf-8 -*-
"""
Created on Mon Dec 28 16:17:13 2020
...
if __name__ == "__main__":
    ...
    with open("intermediate_files.txt", "w") as f:
        ...
        ffmpeg_command = "ffmpeg -y -loglevel error -f concat -safe 0 -i intermediate_files.txt {}".format(args.extra_flags).strip()
        if args.x264 == False:
        ...
        print("Method {}: Input:{}, re-encode to x264:{}, output extension:{}, extra_flags:{}, Time taken: {}".format(
